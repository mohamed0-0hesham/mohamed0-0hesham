...
# Hey there! I'm Mohamed Hesham 👋

### 📱 Android Developer | Kotlin Enthusiast | Mobile Craftsman

[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=firefox&logoColor=white)](https://www.mohamedhesham.dev/)
...
[![App Store](https://img.shields.io/badge/App_Store-0D96F6?style=for-the-badge&logo=appstore&logoColor=white)](https://apps.apple.com/eg/developer/mohamed-hesham/id1895170389)
...
### Mid-Level Android Developer — nWeave *(09/2025 – Present)*
- Architected scalable, maintainable Android project structures aligned with modern best practices, reducing onboarding time for new features.
- Led modularization initiatives, breaking monolithic code into reusable modules shared across multiple production projects.
- Mentored junior developers through code reviews and one-on-one sessions, translating ambiguous business requirements into clear technical solutions.
- Decomposed complex features into structured, well-scoped tasks and enforced high code-quality standards through systematic peer review.

### Android Developer — nWeave *(11/2022 – 09/2025)*
- Developed production Android apps in Kotlin and Jetpack Compose using MVVM and MVI architectures.
- Integrated Bluetooth Low Energy (BLE) for hardware-connected biofeedback devices, enabling real-time data streaming.
- Built offline-first systems with Room and WorkManager for reliable UX under unstable network conditions.
- Integrated Firebase (Auth, Firestore, Crashlytics, Analytics) and Google Play Billing for subscriptions.
- Managed Google Play release cycles, performance profiling, and ANR reduction.
...
| **KMP** | ![Kotlin Multiplatform](https://img.shields.io/badge/Kotlin_Multiplatform-7F52FF?style=flat-square&logo=kotlin&logoColor=white) ![Compose Multiplatform](https://img.shields.io/badge/Compose_Multiplatform-7F52FF?style=flat-square&logo=kotlin&logoColor=white) ![Koin](https://img.shields.io/badge/Koin-FF7043?style=flat-square&logoColor=white) ![kotlinx.serialization](https://img.shields.io/badge/kotlinx.serialization-7F52FF?style=flat-square&logo=kotlin&logoColor=white) ![Voyager](https://img.shields.io/badge/Voyager_Navigation-7F52FF?style=flat-square&logo=kotlin&logoColor=white) |
| **Android Core** | ![ViewModel](https://img.shields.io/badge/ViewModel-3DDC84?style=flat-square&logo=android&logoColor=white) ![WorkManager](https://img.shields.io/badge/WorkManager-3DDC84?style=flat-square&logo=android&logoColor=white) ![AlarmManager](https://img.shields.io/badge/AlarmManager-3DDC84?style=flat-square&logo=android&logoColor=white) ![Navigation](https://img.shields.io/badge/Navigation_Component-3DDC84?style=flat-square&logo=android&logoColor=white) |
...
| **🎉 Squad Games** | Cross-platform party & board games app built with **Kotlin Multiplatform** & Compose Multiplatform — published on **Android & iOS** | [![Google Play](https://img.shields.io/badge/Google_Play-3DDC84?style=flat-square&logo=googleplay&logoColor=white)](https://play.google.com/store/apps/details?id=com.hesham0_0.tegi_netaraf) [![App Store](https://img.shields.io/badge/App_Store-0D96F6?style=flat-square&logo=appstore&logoColor=white)](https://apps.apple.com/app/squad-games-party-games/id6741523461) |
| **💬 Marassel** | Real-time chat app with offline-first architecture, WorkManager background delivery, and **195+ automated tests** across unit, Robolectric & Compose UI layers | [![GitHub](https://img.shields.io/badge/Code-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/mohamed0-0hesham/Marassel) |
...
- 🎓 **Developing Android Apps with Kotlin** — Udacity *(2023)*
- 🎓 **Android Development Using Java & Kotlin** — Faculty of Engineering Lab Center *(2020)*
- 📊 **Marketing Professional Course** — American Chamber of Commerce *(2022)*
- 📋 **Fundamentals of Project Management** — The American University in Cairo *(2021)*
